(defproject wow-auctions "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "wow-auctions.client.core/on-js-reload"
                ...
                :compiler {:main wow-auctions.client.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/wow_auctions.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/wow_auctions.js"
                           :main wow-auctions.client.core
